...
## This feels like it should be unnecessary, but I've found that the script behaves a bit
## unpredictably if I remove it. You may be able to lower the value, I haven't really
